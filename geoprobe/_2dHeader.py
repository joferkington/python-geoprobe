...
headerDef = {
        ...
        'sampleRate':       {'offset':176,  'type':'>f',    'default':None ,       'doc':'Sample rate of the traces'},
        'x0':               {'offset':180,  'type':'>f',    'default':0    ,       'doc':'X-axis calibration factor (e.g. x = i*dx + x0, where i is the index value)'},
        'y0':               {'offset':184,  'type':'>f',    'default':0    ,       'doc':'Y-axis calibration factor'},
        'z0':               {'offset':188,  'type':'>f',    'default':0    ,       'doc':'Z-axis calibration factor'},
        'v0':               {'offset':192,  'type':'>f',    'default':0    ,       'doc':'Voxel value calibration factor'},
        'v0User':           {'offset':196,  'type':'>f',    'default':0    ,       'doc':'User-specified voxel value calibration factor (No idea what that means!)'},
        'dx':               {'offset':200,  'type':'>f',    'default':1    ,       'doc':'X-axis scaling factor'},
        'dy':               {'offset':204,  'type':'>f',    'default':1    ,       'doc':'Y-axis scaling factor'},
        'dz':               {'offset':208,  'type':'>f',    'default':1    ,       'doc':'Z-axis scaling factor'},
        'dv':               {'offset':212,  'type':'>f',    'default':1    ,       'doc':'Voxel value scaling factor'},
        'dvUser':           {'offset':216,  'type':'>f',    'default':1    ,       'doc':'User-specified voxel value scaling factor (No idea what that means!)'},
        ...
        'createdByUser':    {'offset':448,  'type':'32s',   'default':None ,       'doc':'File originally created by username given'},
        'creationDate':     {'offset':480,  'type':'>I',    'default':None ,       'doc':'Unix-style timestamp of the original creation date'},
        'lastModifiedUser': {'offset':484,  'type':'32s',   'default':None ,       'doc':'File last modified by username given'},
        'lastModifiedDate': {'offset':516,  'type':'>I',    'default':None ,       'doc':'Unix-style timestamp of last modified on date'},
